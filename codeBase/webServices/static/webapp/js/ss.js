...
//   /**
//   * ----------------------------------------
//   * Button افزودن به سبد خرید (Change text!)
//   * ----------------------------------------
//   */
//
...
//       $(".textCart").text(($(".textCart").text() == 'افزودن به سبد خرید') ? 'اضافه شد' : 'افزودن به سبد خرید').fadeIn();
//     });
//   });
//
//   /**
...
//     $(this).toggleClass('active');
//     $(".textCart").fadeOut(function () {
//       $(".textCart").text(($(".textCart").text() == 'ذخیره') ? 'ذخیره شد' : 'ذخیره').fadeIn();
//     });
//   });
//
//
...
// var textOnline = "ارتباط با اینترنت برقرار شد";
// var textOffline = "ارتباط با اینترنت قطع میباشد";
//
// //Add Offline Toasts
