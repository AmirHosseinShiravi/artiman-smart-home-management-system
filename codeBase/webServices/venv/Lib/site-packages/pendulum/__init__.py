...
def now(tz=None):  # type: (Optional[Union[str, _Timezone]]) -> DateTime
    ...
    if tz is None or tz == "local":
        # added by me :) because _datetime.datetime.now(local_timezone()) return asia/tehran datetime with +4:30 instead of +3:30
        __local_timezone = pytz.timezone('Asia/Tehran')
        dt = _datetime.datetime.now(tz=__local_timezone)
