...
config = {'name': 'leave Home', 'index': 0, 'rule_uuid': 'b4a2ad51-1b29-443b-bb1a-261a0a9f7453', 'project_uuid': 'fa1d1043-54bf-424b-9aab-fbae54d873c9', 'home_uuid': '5dbbeedc-9041-4191-a1fc-f2a4471b7968', 'type': '', 'status': 'enable', 'add_to_home_status': 'true', 'style': {'color': '#caffbf'}, 'show_scene_rule_in_zones': ['4ee3f099-0efc-4161-8722-ecc4710bf860', '806cad60-d6d6-4a99-9c95-51bcb1976aba'], 'decision_expr': 'or', 'effective_time': {'start': '00:00:00', 'end': '23:59:59', 'loops': '1111111', 'timezone_id': 'Asia/Tehran'}, 'conditions': [], 'actions': [{'code': 1, 'action_executor': 'delay', 'executor_property': {'delay_seconds': '600'}}]}
